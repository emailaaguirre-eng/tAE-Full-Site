...
export default function GiftIdeas() {
  const giftIdeas = [
    {
      ...
      image: "/images/doginthepark.png", // Will need to update with correct image
      description: "Upload a memorable image that will be transformed into a beautiful piece of art. You will also be able to upload personal content using our upload center, where you can load your favorite song, video clips, or e-gift card. When the giftee scans the discreetly placed Art Key, they will access the media you personalized for them. A gift like no other that is personalized to the recipient!",
    },
    {
      id: 2,
      title: "As a Wedding or Anniversary Gift",
      image: "/images/forweddings.jpeg",
    ...
    },
    {
      ...
      image: "/images/specialcustomer.png",
  ...
  return (
    <section id="gift-ideas" className="py-20" style={{ backgroundColor: '#ffffff' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-brand-darkest max-w-2xl mx-auto">
            Our art and images feature a discreetly located Art Key or QR Code that you can customize. Our images get to tell a personalized story!
          </p>
        </div>
              ...
              <div className="relative">
                ...
                <div className="aspect-[4/3] bg-gray-100 relative">
                  <Image
                    ...
                    alt={idea.title}
                    fill
                    className={idea.id === 3 ? "object-contain" : "object-cover"}
                  />
                </div>
              </div>
              <div className="p-6">
